...
#include "xian_dj_retractable_platform_param_pkg/xian_dj_retractable_platform_paramsConfig.h"
//define call back function
void paramCallback(xian_dj_retractable_platform_param_pkg::xian_dj_retractable_platform_paramsConfig& config,uint32_t level)
{
    ROS_INFO("Request");
}
int main(int argc, char** argv)
{
    ...
    ros::init(argc,argv,"xian_dj_retractable_platform_params_server");
    //create node handle
    dynamic_reconfigure::Server<xian_dj_retractable_platform_param_pkg::xian_dj_retractable_platform_paramsConfig> server;
    dynamic_reconfigure::Server<xian_dj_retractable_platform_param_pkg::xian_dj_retractable_platform_paramsConfig>::CallbackType f;
