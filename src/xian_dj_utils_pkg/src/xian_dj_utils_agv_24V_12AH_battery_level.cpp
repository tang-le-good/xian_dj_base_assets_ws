...
class XianDjAgv24V12AHBatteryLevel
{
    public:
        ...
        void m_timer_heart_beat_func(const ros::WallTimerEvent& event)
        {
            ...
            if(timeout_counter >= 5)
            {
                ...
                xian_dj_utils_agv_24V_12AH_battery_level_heart_beat = 0;
                heart_beat_msg.data = xian_dj_utils_agv_24V_12AH_battery_level_heart_beat;
                xian_dj_utils_agv_battery_level_state_pub.publish(heart_beat_msg);
            }
            else
            {
               xian_dj_utils_agv_24V_12AH_battery_level_heart_beat = xian_dj_utils_agv_24V_12AH_battery_level_heart_beat > 1000 ? 0 : (xian_dj_utils_agv_24V_12AH_battery_level_heart_beat + 1);
                std::cout << "xian_dj_utils_agv_24V_12AH_battery_level_heart_beat: " << xian_dj_utils_agv_24V_12AH_battery_level_heart_beat << std::endl;
                heart_beat_msg.data = xian_dj_utils_agv_24V_12AH_battery_level_heart_beat;
                xian_dj_utils_agv_battery_level_state_pub.publish(heart_beat_msg);
            }
        ...
        void m_timer_control_func(const ros::WallTimerEvent& event)
        {
            ...
            if(tcp_server_date!=nullptr)
            {
                ...
                // printf("电池电量： %u  \n",battery_level);
                xian_dj_utils_agv_24V_12AH_battery_level = std::to_string(battery_level);
                xian_dj_utils_agv_24V_12AH_battery_level_msg.data = xian_dj_utils_agv_24V_12AH_battery_level;
                xian_dj_utils_agv_battery_level_pub.publish(xian_dj_utils_agv_24V_12AH_battery_level_msg);
                std::cout << "xian_dj_utils_agv_24V_12AH_battery_level: " << xian_dj_utils_agv_24V_12AH_battery_level << std::endl; 
            }
    ...
    private:
        // 心跳
        int xian_dj_utils_agv_24V_12AH_battery_level_heart_beat = 0;
        std::string xian_dj_utils_agv_24V_12AH_battery_level;
        int date_recive_counter = 0;
        int date_recive_counter_cur = 0;
        int date_recive_counter_pre = 0;
        int timeout_counter = 0;
        std_msgs::String xian_dj_utils_agv_24V_12AH_battery_level_msg;
...
int main(int argc, char** argv)
{
    ...
    xian_dj_utils_agv_24V_12AH_battery_level.m_timer_heart_beat = nh_2.createWallTimer(ros::WallDuration(1.0), &XianDjAgv24V12AHBatteryLevel::m_timer_heart_beat_func, &xian_dj_utils_agv_24V_12AH_battery_level);
    xian_dj_utils_agv_24V_12AH_battery_level.m_timer_control = nh_2.createWallTimer(ros::WallDuration(1), &XianDjAgv24V12AHBatteryLevel::m_timer_control_func, &xian_dj_utils_agv_24V_12AH_battery_level);
    ros::waitForShutdown();
