...
int main(int argc, char** argv)
{
    ...
    xian_dj_retractable_platform_control.m_timer_control = nh_2.createWallTimer(ros::WallDuration(1), &XianDjRetractablePlatformControl::m_timer_control_func, &xian_dj_retractable_platform_control);
    ros::waitForShutdown();
