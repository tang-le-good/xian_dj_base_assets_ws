...
int main(int argc, char** argv)
{
    ...
    xian_dj_tele_op_controller_client.m_timer_control = nh_2.createWallTimer(ros::WallDuration(2.0), &XianDjTeleOpControllerClient::m_timer_control_func, &xian_dj_tele_op_controller_client);
    ros::waitForShutdown();
