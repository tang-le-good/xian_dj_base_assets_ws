...
import sys
import select
# from xian_dj_robotgo1_control_pkg.msg import xian_dj_robotgo1_lighter_displayer
...
class XianDjUtilsYKLED3605Displayer:
    def __init__(self):
        #TCP参数
        ...
        self.tcp_init()
         ...
         # 订阅话题
        rospy.Subscriber("xian_dj_utils_YK_LED3605_displayer_msg", String, self.callback)
        # 发布话题
        self.pub_msg = rospy.Publisher("xian_dj_utils_YK_LED3605_displayer_state_msg", UInt16, queue_size=1)
        self.heart_beat_msg = UInt16()
        self.xian_dj_utils_YK_LED3605_displayer_heart_beat = 0
        
        self.xian_dj_utils_YK_LED3605_displayer_cmd = "$001,54321#"


    def callback(self, data):
        self.xian_dj_utils_YK_LED3605_displayer_cmd = data.data
        
    def xian_dj_utils_YK_LED3605_displayer_func(self, event):
        print("self.xian_dj_utils_YK_LED3605_displayer_cmd:", self.xian_dj_utils_YK_LED3605_displayer_cmd)
        ...
        # 准备发送不同长度的消息
        message_to_send = self.xian_dj_utils_YK_LED3605_displayer_cmd
        ...
        if not self.client.send_data(message_to_send, add_delimiter=False):
            ...
            # 心跳
            if self.xian_dj_utils_YK_LED3605_displayer_heart_beat>1000:
                self.xian_dj_utils_YK_LED3605_displayer_heart_beat = 0
            self.xian_dj_utils_YK_LED3605_displayer_heart_beat += 1
            print("xian_dj_utils_YK_LED3605_displayer_heart_beat:", self.xian_dj_utils_YK_LED3605_displayer_heart_beat)
        self.heart_beat_msg.data = self.xian_dj_utils_YK_LED3605_displayer_heart_beat
...
if __name__ == '__main__':
    try:
        tt = XianDjUtilsYKLED3605Displayer()
        rospy.init_node('xian_dj_utils_YK_LED3605_displayer', anonymous=True)  # 初始化ROS节点
        rospy.Timer(rospy.Duration(1), tt.xian_dj_utils_YK_LED3605_displayer_func, oneshot=False) # 数显模块线程
