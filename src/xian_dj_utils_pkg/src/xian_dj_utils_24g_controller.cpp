...
#include <iomanip>
#include <iostream>
#include "xian_dj_utils_pkg/xian_dj_utils_24g_controller.h"
#include <std_msgs/UInt16.h>

class XianDjUtils24gController
{
    public:
        XianDjUtils24gController()
        {
            // 创建一个ROS节点句柄
            ros::NodeHandle nh;
            controller_sub = nh.subscribe<sensor_msgs::Joy>("joy", 10, &XianDjUtils24gController::controller_callback, this);
            xian_dj_utils_24g_controller_state_pub = nh.advertise<std_msgs::UInt16>("xian_dj_utils_24g_controller_state_msg", 1);
            xian_dj_utils_24g_controller_pub = nh.advertise<xian_dj_utils_pkg::xian_dj_utils_24g_controller>("xian_dj_utils_24g_controller_msg", 1); 
        }
        ...
        {
            xian_dj_utils_24g_controller_heart_beat = xian_dj_utils_24g_controller_heart_beat > 1000 ? 0 : (xian_dj_utils_24g_controller_heart_beat + 1);
            std::cout << "xian_dj_utils_24g_controller_heart_beat: " << xian_dj_utils_24g_controller_heart_beat << std::endl;
            heart_beat_msg.data = xian_dj_utils_24g_controller_heart_beat;
            xian_dj_utils_24g_controller_state_pub.publish(heart_beat_msg);
        }
        ...
        void controller_callback(const sensor_msgs::Joy::ConstPtr &Joy)
        {
            ...
            xian_dj_utils_24g_controller_pub.publish(pub_msg);
    ...
    private:
        ...
        ros::Publisher xian_dj_utils_24g_controller_state_pub;
        ros::Publisher xian_dj_utils_24g_controller_pub;
        xian_dj_utils_pkg::xian_dj_utils_24g_controller pub_msg;
        std_msgs::UInt16 heart_beat_msg;
        int xian_dj_utils_24g_controller_heart_beat = 0;
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc,argv,"xian_dj_utils_24g_controller");
    XianDjUtils24gController xian_dj_utils_24g_controller;
    ...
    xian_dj_utils_24g_controller.m_timer_heart_beat = nh_2.createWallTimer(ros::WallDuration(1.0), &XianDjUtils24gController::m_timer_heart_beat_func, &xian_dj_utils_24g_controller);
    ros::waitForShutdown();
