...
int main(int argc, char** argv)
{
    ...
    xian_dj_car_chassis_back_end.m_timer_heart_beat = nh_2.createWallTimer(ros::WallDuration(1.0), &XianDjCarBackEnd::m_timer_heart_beat_func, &xian_dj_car_chassis_back_end);
    xian_dj_car_chassis_back_end.m_timer_control = nh_2.createWallTimer(ros::WallDuration(0.1), &XianDjCarBackEnd::m_timer_control_func, &xian_dj_car_chassis_back_end);
    ros::waitForShutdown();
